...
- Program complete: **no**
- Tasks: **36**
- Status distribution: AWAITING_OWNER 6, LOCAL_READY 17, MEASURED 2, PLANNED 8, PUBLISHED_VERIFIED 3
...
| github | 4 | LOCAL_READY: 3, PUBLISHED_VERIFIED: 1 |
| datasets | 4 | LOCAL_READY: 2, PLANNED: 1, PUBLISHED_VERIFIED: 1 |
| cloud_stacking | 4 | LOCAL_READY: 2, PLANNED: 1, PUBLISHED_VERIFIED: 1 |
| tier1 | 3 | AWAITING_OWNER: 2, PLANNED: 1 |
| tier23 | 2 | AWAITING_OWNER: 2 |
| profiles | 4 | AWAITING_OWNER: 1, PLANNED: 3 |
| tools | 2 | LOCAL_READY: 1, MEASURED: 1 |
| entity | 2 | LOCAL_READY: 1, PLANNED: 1 |
| backlinks_citations | 2 | LOCAL_READY: 1, PLANNED: 1 |
| search | 2 | LOCAL_READY: 1, MEASURED: 1 |
| ai_visibility | 2 | AWAITING_OWNER: 1, LOCAL_READY: 1 |
